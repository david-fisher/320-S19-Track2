...
class User(AbstractUser):
    ...
    stripe_card = models.CharField(max_length=100, default="") # The last card sent from the frontend
    stripe_customer = models.CharField(max_length=100, default="") # Stripe Customer Token Generated by payment processor / stripe api
